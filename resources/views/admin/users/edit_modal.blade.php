            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="editUserModalLabel">
                        {{ trans('global.edit with name', ['name' => $user->name]) }}</h5>
                </div>
                <div class="modal-body">
                    <form
                        action="{{ $user->type == 'supplier' ? route('admin.users.update', [$user]) : route('admin.users.stores.update', [$user]) }}"
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-import" form="editUserForm">{{ trans('global.save') }}</button>
