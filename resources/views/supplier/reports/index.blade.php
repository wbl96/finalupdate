        ...
        <div class="row">
            <div class="col-12 col-md-4 mb-4">
                <div class="card bg-white shadow-sm border-light h-100">
                    <div class="card-body">
                        <h5 class="card-title">{{ trans('reports.report of', ['name' => trans('reports.sales')]) }}</h5>
                        <div class="icon-container">
                            <i class="bi bi-calculator-fill icon"></i>
                        </div>
                    </div>
                    <a href="{{ route('supplier.reports.sales') }}" class="stretched-link"></a>
                </div>
            </div>
            <div class="col-12 col-md-4 mb-4">
                <div class="card shadow-sm border-dark highlight h-100">
                    <div class="card-body">
                        <h5 class="card-title">{{ trans('reports.report of', ['name' => trans('reports.products')]) }}</h5>
                        <div class="icon-container">
                            <i class="bi bi-cart-fill icon"></i>
                        </div>
                    </div>
                    <a href="{{ route('supplier.reports.products') }}" class="stretched-link"></a>
                </div>
            </div>
            <div class="col-12 col-md-4 mb-4">
                <div class="card bg-white shadow-sm border-light h-100">
                    ...
                    <a href="{{ route('supplier.reports.payments') }}" class="stretched-link"></a>
                </div>
            </div>
        </div>
    </div>
