<div class="modal fade" id="modal_freeze" tabindex="-1" role="dialog"
    aria-labelledby="modal_freeze" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" style="width: 100vw; height:100vh; margin:0; padding:0; max-width: unset;">
        <div class="modal-content" style="height: 100%; min-height:100%; opacity:.8">
            <div class="modal-body" style="display: flex;
            align-items: center;
            justify-content: center;
            flex-direction: column;">
                <div class="ah-loading">
                    <div style="color: #87c4a3" class="la-ball-spin-clockwise-fade-rotating la-3x">
                        <div></div>
                        <div></div>
                        <div></div>
                        <div></div>
